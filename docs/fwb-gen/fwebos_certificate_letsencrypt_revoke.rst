:source: fwebos_certificate_letsencrypt_revoke.py

:orphan:

.. fwebos_certificate_letsencrypt_revoke.py:
...
.. raw:: html
 ...
 <tr>
 <td>fwebos_certificate_letsencrypt_revoke.py</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
  ...
  <li><span class="li-head">body</span> Possible parameters to go in the body for the request <span class="li-required">required: True </li>
        <ul class="ul-self">
              ...
              <li><span class="li-head"> domain </span> domain <span class="li-normal"> type:str</span></li>
