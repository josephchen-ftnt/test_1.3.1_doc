:source: fwebos_waf_dlp_dictionary.py

:orphan:

.. fwebos_waf_dlp_dictionary.py:
...
.. raw:: html
 ...
 <tr>
 <td>fwebos_waf_dlp_dictionary.py</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
  ...
  <li><span class="li-head">body</span> Possible parameters to go in the body for the request <span class="li-required">required: True </li>
        <ul class="ul-self">
              ...
              <li><span class="li-head"> comment </span> Comment for the dictionary.<span class="li-normal"> type:string 
