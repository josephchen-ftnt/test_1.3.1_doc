:source: fwebos_waf_json_protection_policy_item.py

:orphan:

.. fwebos_waf_json_protection_policy_item.py:
...
.. raw:: html
 ...
 <tr>
 <td>fwebos_waf_json_protection_policy_item.py</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
  ...
  <li><span class="li-head">body</span> Possible parameters to go in the body for the request <span class="li-required">required: True </li>
        <ul class="ul-self">
              ...
              <li><span class="li-head"> input_rule </span> The name of JSON Protection Policy Rule.<span class="li-normal"> type:string 
                    maxLength:63</span></li>  
