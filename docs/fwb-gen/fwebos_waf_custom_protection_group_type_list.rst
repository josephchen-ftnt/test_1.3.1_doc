:source: fwebos_waf_custom_protection_group_type_list.py

:orphan:

.. fwebos_waf_custom_protection_group_type_list.py:
...
Synopsis
--------
Assign FortiWeb Custom Policy Custom Rule to policy
...
.. raw:: html
 ...
 <tr>
 <td>fwebos_waf_custom_protection_group_type_list.py</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
  ...
  <li><span class="li-head">body</span> Possible parameters to go in the body for the request <span class="li-required">required: True </li>
        <ul class="ul-self">
              ...
              <li><span class="li-head"> custom_protection_rule </span> custom protection rule <span class="li-normal"> type:str</span></li>
