:source: fwebos_waf_url_rewriting_policy.py

:orphan:

.. fwebos_waf_url_rewriting_policy.py:
...
Synopsis
--------
Config FortiWeb URL Rewriting Policy
...
.. raw:: html
 ...
 <tr>
 <td>fwebos_waf_url_rewriting_policy.py</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 - name:
   ...
   tasks:
    - name: add a URL rewriting policy
      fwebos_waf_url_rewriting_policy:
       action: add 
       name: rp1
