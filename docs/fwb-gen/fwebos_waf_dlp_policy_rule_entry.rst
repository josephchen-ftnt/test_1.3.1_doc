:source: fwebos_waf_dlp_policy.py

:orphan:

.. fwebos_waf_dlp_policy_rule_entry.py:
...
.. raw:: html
  ...
  <li><span class="li-head">body</span> Possible parameters to go in the body for the request <span class="li-required">required: True </li>
        <ul class="ul-self">
              <li><span class="li-head"> name </span> The name of Data Loss Preventation Policy.<span class="li-normal"> type:string 
                    maxLength:63</span></li>     
              <li><span class="li-head"> rule </span> The name of Data Loss Preventation Rule to be added/replaced/removed.<span class="li-normal"> type:string 
                    maxLength:63</span></li>                             
