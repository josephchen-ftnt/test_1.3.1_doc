:source: fwebos_waf_url_access_policy_rule.py

:orphan:

.. fwebos_waf_url_access_policy_rule.py:
...
.. raw:: html
 ...
 <tr>
 <td>fwebos_waf_url_access_policy_rule.py</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
  ...
  <li><span class="li-head">body</span> Possible parameters to go in the body for the request <span class="li-required">required: True </li>
        <ul class="ul-self">
              ...
              <li><span class="li-head"> url_access_rule_name </span> url access rule name <span class="li-normal"> type:str</span></li>
